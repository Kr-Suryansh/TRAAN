...
- Events broadcast: `incident_created`, `incident_updated`, `incident_dispatched`, `resource_updated`
- Events named in contract but not yet triggered: `situation_brief_updated` (requires situation-brief AI endpoint)
