...
object SosRequestMapper {
    ...
    fun toEntity(sos: SOSRequest): SosRequestEntity = SosRequestEntity(
        ...
        severityHint = sos.severityHint?.let { hint ->
            com.sih.data.model.SeverityHint.valueOf(hint.name).apiValue
        },
    ...
    fun toSosRequest(entity: SosRequestEntity): SOSRequest = SOSRequest(
        ...
        severityHint = entity.severityHint?.let { severityHintOf(it) },
    ...
    private fun severityHintOf(apiValue: String): com.sih.relay.model.SeverityHint? {
        val name = com.sih.data.model.SeverityHint.fromApiValue(apiValue)?.name ?: return null
        return runCatching { com.sih.relay.model.SeverityHint.valueOf(name) }.getOrNull()
    }
