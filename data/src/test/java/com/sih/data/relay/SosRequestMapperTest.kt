...
import com.sih.data.model.SeverityHint as DataSeverityHint
...
class SosRequestMapperTest {
    ...
    fun `toEntity maps every SOSRequest field`() {
        ...
        assertEquals(DataSeverityHint.HIGH.apiValue, entity.severityHint)
    ...
    fun `quick sos round trips with null severity and null snapshot`() {
        ...
        assertNull(entity.severityHint)
    ...
    fun `entity side degrades unknown api values to contract defaults`() {
        ...
        assertEquals(EmergencyType.UNSPECIFIED, sos.emergencyType)
